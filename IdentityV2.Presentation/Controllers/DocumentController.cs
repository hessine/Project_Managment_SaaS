...
namespace IdentityV2.Presentation.Controllers
{
    public class DocumentController : Controller
    {
        ...
        public ActionResult Create(DocumentVM DocVM, HttpPostedFileBase Image)
        {
            ...
            Image.SaveAs(path);
            // MailMessage mail = new MailMessage("manel.benamara@esprit.tn", "manel.benamara@esprit.tn");
            ...
            //  smtpClient.Credentials = new System.Net.NetworkCredential("manel.benamara@esprit.tn", "123456aze");
